...
BEST_FEATURES = params["features"]["knn_best"]
...
with mlflow.start_run(run_name="KNN"):
    model = KNeighborsClassifier(
        n_neighbors=params["models"]["knn_neighbors"]
    )
    ...
    mlflow.log_param("neighbors", params["models"]["knn_neighbors"])
